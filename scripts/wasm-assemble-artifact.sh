...
# The shipping bundle set is deliberately small: the parked software rasterizer
# and the primary WebGlideNitro WebGPU renderer. Bundles are renamed by the
# CMake output name so the Emscripten-generated .js can still locate its own
# .wasm sibling by basename.
